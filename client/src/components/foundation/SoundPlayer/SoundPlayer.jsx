...
const SoundPlayer = ({ sound }) => {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full bg-gray-300">
      <audio ref={audioRef} preload="none" loop={true} src={blobUrl} onTimeUpdate={handleTimeUpdate} />
      <div className="p-2">
        <button
      ...
      <div className="flex flex-col flex-grow flex-shrink pt-2 min-w-0 h-full">
        <p className="whitespace-nowrap overflow-ellipsis text-sm font-bold overflow-hidden">{sound.title}</p>
        <p className="whitespace-nowrap overflow-ellipsis text-gray-500 text-sm overflow-hidden">{sound.artist}</p>
        <div className="pt-2">
